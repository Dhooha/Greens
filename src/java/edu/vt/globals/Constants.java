...
public final class Constants {
     ...
     */
    public static final String PHOTOS_ABSOLUTE_PATH = "dir=C:/Users/Melanie/DocRoot/Greens";
    ...
    to allow our application to read and write files external to (outside of) its deployed directory.
        ...
        <property name="alternatedocroot_1" value="from=/SurveyUserPhotoStorage/* dir=/Users/Balci/DocRoot" />

    dir=    specifies the DocRoot directory's absolute path where the external files are stored.
    from=   /SurveyUserPhotoStorage/* specifies the top directory in the DocRoot directory.
    *       implies that you can put directories and files within the /SurveyUserPhotoStorage/ top directory.

    NOTE:   Pay attention to the slashes! Different parts will be combined to form a file path specification,
            Example: /Users/Balci/DocRoot/SurveyUserPhotoStorage/defaultUserPhoto.png
    ...
    Then, for example, when
        ...
        /BevQ/SurveyUserPhotoStorage/defaultUserPhoto.png
    ...
    DocRoot to obtain the absolute path to the file, 
        ...
        /Users/Balci/DocRoot/SurveyUserPhotoStorage/defaultUserPhoto.png
