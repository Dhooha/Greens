...
public class UserController implements Serializable {
    ...
    **********************************************************
    ...
    public String createAccount() {
        ...
        try {
            ...
            newUser.setDeliveryAddress1(deliveryAddress1);
            newUser.setDeliveryAddress2(deliveryAddress2);
            newUser.setDeliveryCity(deliveryCity);
    ...
    ***********************************************************
    ...
    public String updateAccount() {
        ...
        try {
            ...
            editUser.setDeliveryAddress1(this.selected.getDeliveryAddress1());
            editUser.setDeliveryAddress2(this.selected.getDeliveryAddress2());
            editUser.setDeliveryCity(this.selected.getDeliveryCity());
    ...
    **********************************************
    ...
    public void logout() {
        ...
        deliveryAddress1 = deliveryAddress2 = deliveryCity = deliveryState = deliveryZipcode = "";
